...
<!--        <view class="avatar">
        ...
        <uni-section title="实名信息" type="line">
            <uni-list>
                <uni-list-item class="item" title="实名账号" :rightText="userInfo.realName||'未认证'"
                    link>
                </uni-list-item>
        ...
        <!-- 马甲 -->
        <uni-section class="mt10" title="马甲" type="line">
            <uni-list>
                <uni-list-chat clickable avatarCircle="true" :avatar="avatar_file.url" @click="setNickname('')" :title="userInfo.nickname||'未设置'"></uni-list-chat>
            </uni-list>
        </uni-section>
